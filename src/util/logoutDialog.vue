                    ...
                    <TransitionChild as="template" enter="ease-out duration-300"
                        ...
                        <DialogPanel
                            ...
                            <div class="relative">
                                ...
                                <div class="text-center">
                                    <DialogTitle as="h3"
                                        ...
                                        <p class="text-[#282828] text-[16px] sm:text-[22px] font-bold">Logout</p>
                            ...
                            <div class="mt-5 flex justify-center">
                                ...
                                <button :disabled="editLoader" type="button"
                                    ...
                                    <span class="text-white font-bold" v-if="!editLoader">Confirm</span>
                                </button>
                            </div>
                        </DialogPanel>
                    </TransitionChild>
...
const open = computed(() => store.getters['getIsLogout'])
...
const logout = () => {
    store.dispatch("errorHandle/resetLocal");
    store.commit('setLoginStage','mobile'); 
    store.commit("resetState")
    store.commit("auth/resetState")
    // window.open("https://iifl.codifi.in/#/", "_self")
    router.push("/")
}
