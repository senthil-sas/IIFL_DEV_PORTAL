                ...
                <div class="mt-[40px] sm:mt-[50px]">
                    ...
                    <div class="relative mt-[13px] rounded-md shadow-sm">
                        ...
                        <input :type="showPassword ? 'text' : 'password'" name="password" id="password" ref="passwordRef" v-model="password"
                            class="block w-full rounded-lg md:rounded-[10px] border-0 px-12 h-[40px] sm:h-[50px] text-[#1D1D1F] text-sm md:text-[16px] font-semibold ring-1 ring-inset ring-[#83838B] placeholder:text-gray-400  sm:text-sm focus:ring-[#83838B]  focus-visible:outline-none" placeholder="" @input="resetError()" maxlength="12" @keydown.space.prevent/>
